...
| Raw JSON | `experiment_results_cache/plaplace_final_suite/jax_petsc_element_l5_np8.json` |
| Raw log | `experiment_results_cache/plaplace_final_suite/jax_petsc_element_l5_np8.log` |
