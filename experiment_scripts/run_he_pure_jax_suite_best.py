...
from HyperElasticity3D_jax.solve_HE_jax_newton import run_level


OUT_DIR = Path("experiment_results_cache/he_pure_jax_stcg_best")
CASES = [
    (24, 1),
    (24, 2),
    (24, 3),
        ...
        rows.append(
            {
                ...
                "total_dofs": payload["total_dofs"],
                "free_dofs": payload["free_dofs"],
                "time": payload["time"],
                "total_newton_iters": payload["total_newton_iters"],
                "total_linear_iters": payload["total_linear_iters"],
                "max_step_time": max(float(step["time"]) for step in payload["steps"]),
