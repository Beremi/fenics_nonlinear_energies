#!/usr/bin/env python3
"""
Benchmark newtontr + fgmres + HYPRE with different ksp_rtol values.
Levels 5-9, 3 runs median. Output to tmp_work/tr_results_*.txt
"""
...
# Read ksp_rtol from environment variable, default 1e-3
...
def solve_gl(mesh_level):
    ...
    # Set objective for trust region
...
for lvl in [5, 6, 7, 8, 9]:
    ...
    if rank == 0:
        ...
        print(line)
        sys.stdout.flush()
        outfile = "/work/tmp_work/tr_ksp{}_np{}.txt".format(
