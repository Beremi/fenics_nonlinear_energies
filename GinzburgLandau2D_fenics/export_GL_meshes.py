...
Usage (inside devcontainer or Docker):
  python3 GinzburgLandau2D_fenics/export_GL_meshes.py
...
output_dir = "mesh_data/GinzburgLandau"
...
for mesh_level in range(2, 10):
    ...
    # Save as XDMF
    filename = os.path.join(output_dir, f"GL_mesh_level_{mesh_level}.xdmf")
