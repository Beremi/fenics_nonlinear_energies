...
def _assignment_bucket(value: object) -> str:
    if value is None:
        return "secondary"
...
def main() -> None:
    ...
    direction_rows = _rows_for(rows, "table_5_13")
        ...
        _append_table(
            ...
            [
                [
                    ...
                    _assignment_bucket(row.get("assignment_acceptance_pass")),
                ]
    ...
    if direction_rows:
        ...
        _append_table(
            lines,
            ["method", "direction", "p", "thesis it", "measured it", "Δit", "thesis dir it", "Δdir it", "assignment", "status"],
            [
                [
                    str(row["method"]),
                    str(row["direction"]),
    ...
    if partial_rows:
        ...
        lines.append("- No partial rows remain.")
