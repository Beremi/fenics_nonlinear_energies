#!/usr/bin/env python3
"""Run a preserved Plasticity3D `P4(L1_2)` showcase at `lambda = 1.55` on 32 MPI ranks."""
...
DEFAULT_RAW_DIR = (
    ...
    / "raw_results"
    / "docs_showcase"
    / "plasticity3d_p4_l1_2_lambda1p55_np32_grad1e2"
)
...
def main() -> None:
    ...
    run_logged_command(
        ...
        notes="Authoritative 32-rank maintained-local Plasticity3D P4(L1_2) lambda=1.55 showcase run.",
    )
    ...
    if str(payload.get("mesh_name", "")) != "hetero_ssr_L1_2":
