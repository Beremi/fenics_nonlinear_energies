#!/usr/bin/env python3
"""Run strong scaling for matched local/source Plasticity3D L1_2 gradient-stop rows."""
...
RUNNER_NAME = "plasticity3d_l1_2_lambda1_grad1e2_scaling_compare"
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run L1_2/lambda=1 gradient-stop scaling for local vs source local_pmg rows."
    )
