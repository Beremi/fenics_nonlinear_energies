#!/usr/bin/env python3
"""Run L5 P4 PMG scaling cases at 1/2/4/8/16/32 MPI ranks with Newton maxit=20."""
...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / "raw_results" / "slope_stability_l5_p4_pmg_scaling_lambda1_maxit20"
