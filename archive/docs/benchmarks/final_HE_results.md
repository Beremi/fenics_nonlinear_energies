...
`../archive/final_HE_results_archive_2026-03-08.md`.
...
| Knob | Value | Notes |
|---|---|---|
| nonlinear method | `rho`-based trust region | implemented in `src/core/petsc/minimizers.py` |
...
`src/problems/hyperelasticity/jax/solve_HE_jax_newton.py` and indexed in
`artifacts/reproduction/2026-03-15_refactor_stage2b_final/full/he_pure_jax_suite_best/summary.md`.
...
- Raw pure-JAX case data are stored in
  `artifacts/reproduction/2026-03-15_refactor_stage2b_final/full/he_pure_jax_suite_best/`, with one `.json` and one
  human-readable `.md` file per run.

### 3. Cross-method comparison: 24 steps

All figures in this section are generated from
`artifacts/reproduction/2026-03-15_refactor_stage2b_final/full/he_final_suite_best/summary.json` by
`experiments/analysis/generate_he_final_report_figures.py`.

#### 3.1 Scaling on levels 1 to 4

![HE 24-step scaling](../assets/he_final/he_scaling_24.png)
...
![HE 24-step runtime vs DOFs at 8 ranks](../assets/he_final/he_dof_runtime_np8_24.png)
...
![HE 96-step scaling](../assets/he_final/he_scaling_96.png)
...
![HE 96-step runtime vs DOFs at 8 ranks](../assets/he_final/he_dof_runtime_np8_96.png)
