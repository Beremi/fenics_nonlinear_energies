...
mpiexec -n 32 ./.venv/bin/python src/problems/topology/jax/solve_topopt_parallel.py \
    ...
    --json_out artifacts/reproduction/2026-03-15_refactor_stage2b_final/full/topology_parallel_final/parallel_full_run.json \
    --state_out artifacts/reproduction/2026-03-15_refactor_stage2b_final/full/topology_parallel_final/parallel_full_state.npz
```
