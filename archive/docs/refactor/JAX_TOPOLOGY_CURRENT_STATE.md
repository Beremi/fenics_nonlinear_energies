...
- Implementation details:
  - [`JAX_TOPOLOGY_jax_petsc_IMPLEMENTATION.md`](../implementation/JAX_TOPOLOGY_jax_petsc_IMPLEMENTATION.md)
- Final benchmark and scaling report:
  - [`final_JAX_TOPOLOGY_parallel_results.md`](../benchmarks/final_JAX_TOPOLOGY_parallel_results.md)
  - [`jax_topology_optimisation_benchmark.md`](../benchmarks/jax_topology_optimisation_benchmark.md) now reflects the refreshed canonical serial rerun from `artifacts/reproduction/2026-03-15_refactor_stage2b_final/full/topology_serial_reference/`
