...
| Raw JSON | `experiment_results_cache/plaplace_final_suite/jax_petsc_local_sfd_l5_np4.json` |
| Raw log | `experiment_results_cache/plaplace_final_suite/jax_petsc_local_sfd_l5_np4.log` |
...
|---:|---:|---:|---:|---:|---|
| 1 | 0.060 | 6 | 6 | -7.942969 | Converged (energy, step, gradient) |
