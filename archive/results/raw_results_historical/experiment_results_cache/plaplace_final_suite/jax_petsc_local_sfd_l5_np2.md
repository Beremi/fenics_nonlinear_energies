...
| Raw JSON | `experiment_results_cache/plaplace_final_suite/jax_petsc_local_sfd_l5_np2.json` |
| Raw log | `experiment_results_cache/plaplace_final_suite/jax_petsc_local_sfd_l5_np2.log` |
...
|---:|---:|---:|---:|---:|---|
| 1 | 0.050 | 6 | 6 | -7.942969 | Converged (energy, step, gradient) |
...
| 5 | -7.942963 | 0.002380 | 0.160770 | nan | 1.055248 | 1 | yes | 9 | 0.000 | 0.004 | 0.001 | 0.003 | 1.000000 | nan |
