...
| Free DOFs | `12033` |
| Setup time [s] | `0.598` |
| Total solve time [s] | `0.296` |
| Total Newton iterations | `7` |
| Total linear iterations | `11` |
| Total assembly time [s] | `0.150` |
| Total PC init time [s] | `0.085` |
| Total KSP solve time [s] | `0.021` |
| Total line-search time [s] | `0.036` |
| Final energy | `-7.954564` |
| Raw JSON | `artifacts/reproduction/2026-03-15_refactor_stage2b_final/full/plaplace_final_suite/jax_petsc_local_sfd_l6_np8.json` |
| Raw log | `artifacts/reproduction/2026-03-15_refactor_stage2b_final/full/plaplace_final_suite/jax_petsc_local_sfd_l6_np8.log` |
...
|---:|---:|---:|---:|---:|---|
| 1 | 0.296 | 7 | 11 | -7.954564 | Converged (energy, step, gradient) |
...
|---:|---:|---:|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 1 | 0.188846 | 65342.817360 | 6978.482874 | nan | 1.956948 | 2 | yes | 9 | 0.145 | 0.013 | 0.003 | 0.006 | 1.000000 | nan |
