...
| Free DOFs | `2945` |
| Setup time [s] | `0.568` |
| Total solve time [s] | `0.299` |
| Total Newton iterations | `7` |
| Total linear iterations | `9` |
| Total assembly time [s] | `0.147` |
| Total PC init time [s] | `0.091` |
| Total KSP solve time [s] | `0.022` |
| Total line-search time [s] | `0.035` |
| Final energy | `-7.942969` |
| Raw JSON | `artifacts/reproduction/2026-03-15_refactor_stage2b_final/full/plaplace_final_suite/jax_petsc_local_sfd_l5_np16.json` |
| Raw log | `artifacts/reproduction/2026-03-15_refactor_stage2b_final/full/plaplace_final_suite/jax_petsc_local_sfd_l5_np16.log` |
...
|---:|---:|---:|---:|---:|---|
| 1 | 0.299 | 7 | 9 | -7.942969 | Converged (energy, step, gradient) |
...
|---:|---:|---:|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 1 | -0.048141 | 8662.126658 | 1796.149353 | nan | 1.956948 | 1 | yes | 9 | 0.145 | 0.014 | 0.003 | 0.005 | 1.000000 | nan |
