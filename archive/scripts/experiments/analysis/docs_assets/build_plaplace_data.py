#!/usr/bin/env python3
"""Build curated pLaplace overview data files."""
...
def _scalar_row(path: Path) -> dict:
...
def _parity_rows() -> list[dict[str, object]]:
    ...
    outputs = {
        ...
        "jax_serial": _scalar_row(base / "jax_serial" / "output.json"),
...
def main() -> None:
    ...
    record_provenance(
        FAMILY_DIR / "build_plaplace_data.provenance.json",
        script_name="overview/img/scripts/build_plaplace_data.py",
        inputs=[
