#!/usr/bin/env python3
"""
Benchmark A3: newtontr + fgmres + ASM+ILU with different ksp_rtol values.
Levels 5-9, 3 reps (1 rep for fails), early stop on failure.
...
def solve_gl(mesh_level, max_reps=3):
    ...
    pfx = "a3{}_{}{}_".format(str(KSP_RTOL).replace('.', ''), nprocs, mesh_level)
...
for lvl in [5, 6, 7, 8, 9]:
    ...
    if rank == 0:
        ...
        outfile = "/work/tmp_work/a3_ksp{}_np{}.txt".format(
