...
| route | solve [s] | Hessian [s] | SFD colors | Newton | linear | energy | omega | u_max | result |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| Element AD | 16.3179 | 6.5683 | -- | 11 | 73 | -3012813.367652 | 6034756.703243 | 0.739001 | completed |
| Local colored SFD | 16.3929 | 6.5934 | 240-420 | 11 | 73 | -3012813.367652 | 6034756.703243 | 0.739001 | completed |
| Constitutive AD | 4.8085 | 1.5973 | -- | 11 | 73 | -3012813.367652 | 6034756.703243 | 0.739001 | completed |

All three derivative routes now reach the same reported energy, displacement
metric, Newton count, and Krylov count. The local colored-SFD route uses
between `240` and `420` colors across the `32` ranks, so its comparable solve
time is not due to an under-colored reconstruction; its batched HVP callback is
