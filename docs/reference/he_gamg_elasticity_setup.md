...
The maintained FEniCS implementation is now in
`src/problems/hyperelasticity/fenics/solver_custom_newton.py`.
...
The maintained JAX+PETSc logic is split between:
