...
Usage:
  Serial:   python3 src/problems/ginzburg_landau/fenics/solve_GL_snes_newton.py
  Parallel: mpiexec -n <nprocs> python3 src/problems/ginzburg_landau/fenics/solve_GL_snes_newton.py
