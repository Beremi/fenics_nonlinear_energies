...
Usage
-----
>>> from src.problems.plaplace.jax_petsc.jax_energy_local import (
...
class CompiledPartition:
    ...
    def __init__(self, partition_data, p, do_warmup=True, warmup_n_dofs=None):
        from src.problems.plaplace.jax_petsc.element_partition import PartitionData
...
def make_partitioned_energy(params, n_partitions, padded=False, do_warmup=True):
    ...
    """
    from src.problems.plaplace.jax_petsc.element_partition import (
