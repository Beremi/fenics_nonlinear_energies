...
Solver logic is in ``src/problems/plaplace/fenics/solver_snes.py``.

Usage:
  Serial:   python3 src/problems/plaplace/fenics/solve_pLaplace_snes_newton.py
  Parallel: mpiexec -n <nprocs> python3 src/problems/plaplace/fenics/solve_pLaplace_snes_newton.py
...
from src.problems.plaplace.fenics.solver_snes import run_level
