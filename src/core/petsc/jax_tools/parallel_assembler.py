...
``src.core.petsc.minimizers.newton``:
...
class DOFHessianAssemblerBase:
    ...
    def __init__(
        ...
        from src.core.petsc.dof_partition import DOFPartition
    ...
    def _setup_coloring(self, comm, trials_per_rank):
        ...
        from src.core.coloring.multistart_coloring import multistart_color
