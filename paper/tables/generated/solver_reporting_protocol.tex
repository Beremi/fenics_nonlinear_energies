...
relative correction & Norm of the accepted Newton correction relative to the current iterate scale; paired gradient checks use the absolute or relative target stated with the result. & Defines the stopping metric in Plasticity3D configurations that report correction or gradient targets. \\
\bottomrule
\end{tabularx}
