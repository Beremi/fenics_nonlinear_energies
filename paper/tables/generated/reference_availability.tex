\begin{tabularx}{\textwidth}{@{}>{\hsize=1.08\hsize\linewidth=\hsize\RaggedRight\arraybackslash}X@{\hspace{0.8em}}>{\hsize=0.58\hsize\linewidth=\hsize\Centering\arraybackslash}X@{\hspace{0.7em}}>{\hsize=0.62\hsize\linewidth=\hsize\Centering\arraybackslash}X@{\hspace{1.0em}}>{\hsize=1.72\hsize\linewidth=\hsize\RaggedRight\arraybackslash}X@{}}
\toprule
