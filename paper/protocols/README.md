...
| EXP-ROUTE-001 | central | [second-architecture fixed-state and full-solve route study](EXP-ROUTE-001.md) | clean 12-block workstation calibration completed 36/36 sequential routes with all correctness gates passing and no timing claim released; Karolina training, holdout, and Tier-B rows remain unsubmitted |
