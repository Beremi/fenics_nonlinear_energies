...
| EXP-GLOB-001 | supplementary unless retained by claim audit | [controlled globalization evidence](EXP-GLOB-001.md) | bounded GL pilot complete; algorithm freeze, controlled linear algebra, multiple instances, and repetitions remain |
