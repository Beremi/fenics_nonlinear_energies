...
def main() -> None:
    ...
    write_tablex(
        ...
        [
            ...
            ["Plasticity2D", "no", "no", "yes", "scalar element potential and same-mesh PMG"],
            ["Plasticity3D", "no", "no", "yes", "element AD, constitutive AD, and PMG"],
    ...
    write_tablex(
        ...
        "@{}" + xcol(1.08) + xcol(0.55, "Centering") + xcol(0.76, "Centering") + xcol(0.55, "Centering") + xcol(0.70, "Centering") + xcol(1.86) + "@{}",
