...
PDE solves through tangent and adjoint equations \citep{yashchuk2023bringing}.
...
contract and the fail-closed comparison of element, constitutive, and colored
routes.

Recent systems narrow this distinction further. Locality-aware AD performs
per-element forward differentiation and sparse Hessian assembly on GPUs
...
conditions, and a common-accuracy route-selection protocol on CPU/MPI systems.
...
turn local Hessian actions into a canonical distributed matrix and to prevent
