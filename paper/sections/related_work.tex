...
these papers define the closest modern literature context for the JAX-based
local differentiation layer and second-order derivative comparisons studied
here.
...
narrower: an implemented nonlinear energy-minimization suite with derivative-route
...
their citations have to distinguish continuum plasticity, strength-reduction
practice, source-family implementations, and the algorithmic endpoint
surrogates studied here.
...
The MATLAB implementation paper of \citet{cermak2019efficient}, with Jan Valdman
as a coauthor, documents an efficient 2D/3D elastoplastic finite-element
implementation lineage for this problem class.
...
reported numerical artifacts below.
