...
endpoint energy, external-work, and maximum-displacement observables. The
...
available, JAX-FEM gives a narrow hyperelastic endpoint-state comparison, and the
Sysala-family and \v{C}erm{\'a}k--Sysala--Valdman works provide plasticity
reference-model and implementation context rather than universal baselines.
