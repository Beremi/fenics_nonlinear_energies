...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[paper box, fill=paperdiagviolet, text width=4.55cm] (deriv) at (3.0,-2.0)
    {\textbf{Derivative modes}\\element AD, constitutive AD, colored SFD};
...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[paper box, fill=paperdiagrose, text width=15.2cm, below=0.45cm of c] (s)
    {\textbf{Colored SFD}\\rank-local AD-HVP probes in reported cases; parallel coloring / recovery; finite-difference gradient probes as the classical variant};
\end{tikzpicture}%
}
