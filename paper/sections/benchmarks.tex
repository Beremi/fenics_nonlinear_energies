...
benchmark, parametrized by load step $\eta$. The strong form is
\begin{equation}
...
validation ladder. Same-case source-faithfulness of the endpoint surrogate
is treated separately from a fixed-lambda source-operator
