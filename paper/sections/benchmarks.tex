...
structure. Let $\varepsilon_1 \ge \varepsilon_2 \ge \varepsilon_3$ be the
...
\end{align}
with the remaining left, right, and apex thresholds obtained from the same
principal-strain ordering and branch-return formulas. The scalar potential is
...
$\Phi_{\mathrm{r}}$, and $\Phi_{\mathrm{a}}$ are branchwise quadratic
corrections to \cref{eq:plasticity3d-elastic-branch}. The
