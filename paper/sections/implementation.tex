...
scientific costs. The serial full-mesh derivative comparison is executed with a
48~GiB modeled-memory guard inside a 64~GiB process address-space ceiling.
Route CSR arrays are written to transient disk-backed storage and compared in
bounded chunks; the complete matrix norms and maximum entrywise defects are
still evaluated, rather than sampled.
