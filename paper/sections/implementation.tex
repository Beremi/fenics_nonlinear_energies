...
They are not intended to be the primary production route for the largest
...
rather than as the mainline production path.
...
\begin{itemize}
  ...
  \item \textbf{Plasticity3D:} local PMG on the same-mesh
        $P_4 \to P_2 \to P_1$ hierarchy, coarse \code{cg + hypre}, and an
...
important structural point is that the \jaxpetsc{} production story is always
