...
\title{Exact and Scalable Nonlinear Finite-Element Solves and Optimization with JAX and PETSc\\
\large Draft manuscript with placeholder front matter}

\author{
Author One$^{1}$ \and Author Two$^{2}$\\
\small $^{1}$Affiliation placeholder\\
\small $^{2}$Affiliation placeholder\\
\small Correspondence: placeholder@example.com
}
